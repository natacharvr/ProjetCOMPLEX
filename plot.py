...
ax.plot([i for i in range(1000,10001, 1000)], [time_couplage[i] for i in range(len(time_couplage)) if i%3==0], '-o', label=f'$p={0.2}$', color=cmap(1))
ax.plot([i for i in range(1000,10001, 1000)], [time_couplage[i] for i in range(len(time_couplage)) if i%3==1],'-o', label=f'$p={0.5}$', color=cmap(2))
ax.plot([i for i in range(1000,10001, 1000)], [time_couplage[i] for i in range(len(time_couplage)) if i%3==2], '-o', label=f'$p={0.8}$', color=cmap(3))
ax.legend()
ax.set_xscale('log')
ax.set_yscale('log')
...
ax2.set_xscale('log')
ax2.set_yscale('log')
ax2.set_xlabel("Taille de l'instance en sommets, échelle logarithmique")
ax2.set_ylabel("Temps d'exécution (s), échelle logarithmique")
...
fig, ax = plt.subplots(figsize=(13,4), nrows=1, ncols=3, sharey=True)
...
ax[0].plot([i for i in range(1000,5001, 1000)], [size_couplage[i] for i in range(len(size_couplage)) if i%3==0],'-o', label="couplage ", color=cmap(2))
ax[0].plot([i for i in range(1000,5001, 1000)], [size_glouton[i] for i in range(len(size_glouton)) if i%3==0], '-o', label="glouton", color=cmap(1))
ax[0].legend()
...
ax[1].plot([i for i in range(1000,5001, 1000)], [size_couplage[i] for i in range(len(size_couplage)) if i%3==1],'-o', label="couplage", color=cmap(2))
ax[1].plot([i for i in range(1000,5001, 1000)], [size_glouton[i] for i in range(len(size_glouton)) if i%3==1], '-o', label="glouton", color=cmap(1))
# ax[1].legend()
...
ax[2].plot([i for i in range(1000,5001, 1000)], [size_couplage[i] for i in range(len(size_couplage)) if i%3==2],'-o', label="couplage", color=cmap(2))
ax[2].plot([i for i in range(1000,5001, 1000)], [size_glouton[i] for i in range(len(size_glouton)) if i%3==2], '-o', label="glouton", color=cmap(1))
# ax[2].legend()
